...
def main() -> None:
    ...
    parser.add_argument('--max-sources', type=int, default=10000, help='Maximum number of workers to include in the subgraph.')
    parser.add_argument('--max-objects', type=int, default=10000, help='Maximum number of tasks to include in the subgraph.')
